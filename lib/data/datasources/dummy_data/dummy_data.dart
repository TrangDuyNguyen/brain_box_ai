List<Map<String, dynamic>> jsonPromptList = [
  ...
  },
  {
    ...
    "content":
        "Discover the best practices to follow when developing Flutter applications, including code organization, testing, and performance optimization.",
    "category": "Flutter",
  ...
  },
  {
    ...
    "content":
        "Dart's null safety feature helps you avoid null reference errors by enforcing null checks at compile-time.",
    "category": "Dart",
  ...
  },
  {
    ...
    "content":
        "Learn how to create smooth and beautiful animations in Flutter using the built-in animation libraries.",
    "category": "Flutter",
  ...
  },
  {
    ...
    "content":
        "Explore various techniques to optimize the performance of your Flutter applications, ensuring a smooth user experience.",
    "category": "Flutter",
